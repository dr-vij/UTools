...
/// <summary>
/// Source: https://github.com/acron0/Easings/blob/master/Easings.cs
/// </summary>
public static class Easings
{
    ...
    /// </summary>
    static public float Linear(float p) => p;

    /// <summary>
    /// Modeled after the parabola y = x^2
    /// </summary>
    static public float QuadraticEaseIn(float p) => p * p;

    /// <summary>
    /// Modeled after the parabola y = -x^2 + 2x
    /// </summary>
    static public float QuadraticEaseOut(float p) => -(p * (p - 2));
    ...
    /// </summary>
    static public float CubicEaseIn(float p) => p * p * p;
    ...
    /// </summary>
    static public float QuarticEaseIn(float p) => p * p * p * p;
    ...
    /// </summary>
    static public float SineEaseIn(float p) => Math.Sin((p - 1) * HALFPI) + 1;

    /// <summary>
    /// Modeled after quarter-cycle of sine wave (different phase)
    /// </summary>
    static public float SineEaseOut(float p) => Math.Sin(p * HALFPI);

    /// <summary>
    /// Modeled after half sine wave
    /// </summary>
    static public float SineEaseInOut(float p) => 0.5f * (1 - Math.Cos(p * PI));

    /// <summary>
    /// Modeled after shifted quadrant IV of unit circle
    /// </summary>
    static public float CircularEaseIn(float p) => 1 - Math.Sqrt(1 - (p * p));

    /// <summary>
    /// Modeled after shifted quadrant II of unit circle
    /// </summary>
    static public float CircularEaseOut(float p) => Math.Sqrt((2 - p) * p);
    ...
    /// </summary>
    static public float ExponentialEaseIn(float p) => (p == 0.0f) ? p : Math.Pow(2, 10 * (p - 1));
    ...
    static public float BounceEaseIn(float p) => 1 - BounceEaseOut(1 - p);
